...
<div class="flex">
  <div
    class="w-1/2 border-r border-titaniumWhite {showPreview ? 'hidden' : ''}"
  >
    <div class="h-[42px] bg-whiteSmoke px-4 py-3">
      <h2
        class="text-sm font-medium uppercase tracking-[0.125rem] text-adeptusBattlegrey"
      >
        Markdown
      </h2>
    </div>
  ...
  <div class="{showPreview ? 'border-b border-white' : 'w-1/2'} bg-white">
    <div class="flex h-[42px] justify-between bg-whiteSmoke px-4 py-3">
      <h2
        class="text-sm font-medium uppercase tracking-[0.125rem] text-adeptusBattlegrey"
      >
        Preview
